...
import 'package:diaclean_customer/app/core/models/rating_model.dart';
          ...
          children: snapshot.data!.docs.map((subAdsDoc) {
            ...
            return Column(
              children: [
                ...
                TypeEvaluation(
                  title: 'Você gostou do atendimento?',
                  complement: 'do Serviço',
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            color: number == numberSelected
                ...
                : getColors(context).primary.withOpacity(.25)),
        alignment: Alignment.center,
        child: Text(
          number.toString(),
          style: textFamily(
