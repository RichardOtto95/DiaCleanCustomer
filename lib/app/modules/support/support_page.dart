                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Question(
                          ...
                          answer:
                              """A MercadoExpresso é uma nova maneira de fazer compras online. Você faz o download do aplicativo MercadoExpresso para iOS ou Android agora mesmo, e realiza atendimentos que poderão chegar até você dentro de até 90 minutos.

Navegue pelas categorias ou utilize a barra de pesquisa para encontrar o que você procura. Depois é só adicionar no carrinho de compras, confirmar o pagamento e pronto! Um Agente se encarregará de trazer seu atendimento em suas mãos.
""",
                        ),
                        Question(
                          title:
                              "Que tipo de Atendimentos eu encontro na MercadoExpresso?",
                          answer:
                              """A disponibilidade de Atendimentos dependerá da sua localização, mas na plataforma você poderá encomendar praticamente qualquer tipo de Atendimento, por exemplo, das seguintes categorias:
...
""",
                        ...
                        Question(
                          title:
                              "Posso especificar um horário de entrega para o meu atendimento?",
                          answer: """Em breve.""",
                        ),
                        Question(
                          title:
                        ...
                        Question(
                          title:
                              "Eu posso solicitar uma nota fiscal para os meus atendimentos?",
                          answer:
                              """Para que possamos realizar a reconciliação fiscal, precisamos da nota física. Por isso, sempre que seu atendimento é entregue, você recebe uma notificação para informar que o seu recibo está disponível. Dentro de alguns dias você encontrará nele uma foto da Nota Fiscal da compra. Além disso, você sempre poderá solicitá-la escrevendo para suporte@mercadoexpresso.com.br. 
...
""",
                        ...
                        Question(
                          title:
                              "Quando meu atendimento chegará e quais são os horários de entrega?",
                          answer:
                              """No momento os atendimentos são entregues aproximadamente 90 minutos após a efetivação do pagamento. No entanto, em breve também estaremos trabalhando com agendamentos de entregas, seja para o mesmo dia ou para qualquer outra data futura, sempre respeitando os horários de funcionamento das lojas. A disponibilidade de horários aparece quando você está concluindo o seu atendimento, no checkout. Lá você vai saber se pode ser sob demanda ou para quando vai poder agendar. """,
                        ),
                        Question(
                          title:
                        ...
                        Question(
                          title:
                              "Como será feita a cobrança do seu atendimento?",
                          answer:
                        ...
                        Question(
                          title:
                              "O que eu faço se precisar de um Atendimento que não está disponível no catálogo da MercadoExpresso?",
                          answer:
                              """Escreva para a MercadoExpresso na seção suporte do aplicativo, detalhando dados importantes como marca, tamanho, quantidade, etc. Quanto melhor for a descrição do Atendimento que você precisa, mais fácil será para que nós consigamos disponibilizá-lo na plataforma o quanto antes. Assim você ajuda a melhorar nosso serviço e a manter nosso catálogo atualizado.""",
                        ),
                        Question(
                          title:
                              "Posso receber meu atendimento em um endereço diferente do habitual?",
                          answer:
                              """Sim! Você pode adicionar vários endereços de entrega à sua conta. O atendimento será entregue no endereço que você escolher, apenas verifique se os dados (número, CEP, etc) estão corretos antes de confirmar a sua compra. Lembre-se que o endereço deve estar em nossa área de cobertura e que a MercadoExpresso não aceita entregas em locais públicos.""",
                        ),
                        Question(
                          title:
                              "O que acontece se eu não conseguir receber meu atendimento? Alguém mais pode recebê-lo por mim?",
                          answer:
                              """Não tem problema. Ao confirmar seu atendimento, diga-nos na seção “Instruções de entrega” ou diretamente no chat com o seu Agente o nome da pessoa que receberá seu atendimento. Não esqueça de fornecer o código de segurança para que esta pessoa possa informar ao Agente e este possa validar o destinatário corretamente antes de entregar a encomenda, caso contrário esta não poderá ser entregue.""",
                        ),
                        Question(
                          title:
                              "Moro em condomínio e quero receber meu atendimento em mãos, como proceder?",
                          answer:
                              """Se for um condomínio horizontal, basta autorizar a entrada do Agente na portaria e deixar claro nas “Instruções para Entrega” que o Agente deverá seguir até a sua residência para entregar seu atendimento em mãos. 

No entanto, para condomínios verticais, o procedimento padrão é encontrar o cliente na portaria e realizar a entrega lá mesmo. A exceção é quando o cliente contratou um serviço adicional para “Entrega em mãos”. Portanto, se for o seu caso e fizer questão de receber seu atendimento em mãos, não se esqueça de incluir o serviço adicional “Entrega em mãos” no momento do checkout para que o Agente que fará a entrega saiba que terá que atender a esta exceção, caso queira aceitar esta missão. """,
                        ),
                        Question(
                          title:
                              "O que eu faço se algo der errado com meu atendimento?",
                          answer:
                        ...
                        Question(
                          ...
                          answer:
                              """O Agente é parceiro da MercadoExpresso, por isso, não podemos garantir que ele vá subir em seu prédio. Normalmente os atendimentos são entregues para você ou por alguém por você autorizado na portaria. No entanto, você pode contratar esse serviço como um adicional ao realizar o checkout da sua compra e neste caso, o Agente que aceitar a missão de entregá-lo, se compromete a fazer cumprir o que foi descrito no campo “Instruções de entrega”. Não se esqueça de que precisará de sua autorização para subir. """,
                        ),
                        Question(
                          title:
                              "Tenho como saber o status do meu atendimento?",
                          answer:
                              """Quando você confirmar sua compra, enviaremos uma notificação com o título ‘Confirmação do atendimento’, na qual você poderá veririar todas as informações referentes à sua compra.

Você pode monitorar o status do seu atendimento pelo aplicativo, saber se o Agente já está buscando o Atendimento, ou se já partiu para o endereço de entrega. """,
                        ),
                        Question(
                          title:
                              "Qual o valor da taxa de serviço na MercadoExpresso?",
                          answer:
                              """A taxa de serviço é um percentual de 15% cobrado sobre o valor final do atendimento.""",
                        ),
                        Question(
                          title:
...
Você pode conferir o ponto “XXX. Pagamento”, para mais detalhes.""",
                        ...
                        Question(
                          ...
                          answer:
                              """O programa de indicações é uma ferramenta da MercadoExpresso onde você pode indicar amigos para usufruírem de nossos serviços. Vá na aba ‘Conta’ e depois ‘Compartilhar’, copie o código e divulgue para todos os seus amigos. Cada pessoa que você convida para a MercadoExpresso ganha uma entrega grátis válida por 14 dias corridos (atendimento mínimo de R\$ 50 reais). E para cada uma delas que faz o cadastro pelo seu código, compra e recebe o atendimento, você ganha R\$ 15,00 em créditos MercadoExpresso válidos por 14 dias corridos. """,
                        ),
                        Question(
                          title:
                              "Como funciona a entrega de bebidas alcoólicas?",
                          answer:
                              """Para que possamos entregar um atendimento que inclua bebidas alcoólicas, uma pessoa maior de idade deve estar presente quando o Agente chegar com a encomenda. Será necessário verificar o RG ou habilitação do cliente. Não se esqueça de beber com moderação!""",
                        ),
                        Question(
