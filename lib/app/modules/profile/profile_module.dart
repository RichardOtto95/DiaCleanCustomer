import 'package:diaclean_customer/app/modules/profile/profile_Page.dart';
import 'package:diaclean_customer/app/modules/profile/profile_store.dart';
import 'package:diaclean_customer/app/modules/profile/widget/answer_rating.dart';
import 'package:diaclean_customer/app/modules/profile/widget/edit_profile.dart';
import 'package:diaclean_customer/app/modules/profile/widget/favorites.dart';
import 'package:diaclean_customer/app/modules/profile/widget/user_pormotional_code.dart';
import 'package:diaclean_customer/app/modules/settings/settings_page.dart';
import 'package:diaclean_customer/app/modules/settings/widgets/app_info.dart';
...
class ProfileModule extends WidgetModule {
  ...
  final List<ModularRoute> routes = [
    ...
    ChildRoute('/user-promotional-code',
        child: (_, args) => UserPromotionalCode()),
  ];
